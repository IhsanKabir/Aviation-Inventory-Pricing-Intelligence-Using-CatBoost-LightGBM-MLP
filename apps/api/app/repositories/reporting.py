...
ROUTE_MATRIX_CACHE_TTL_SEC = 20
ROUTE_DATE_AVAILABILITY_CACHE_TTL_SEC = 20
...
def get_route_monitor_matrix(
    ...
    if resolved_cycle_id not in history_cycle_ids:
        history_cycle_ids.insert(0, resolved_cycle_id)
