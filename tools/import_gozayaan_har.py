"""
Import GoZayaan HAR captures into the offer cache used by the KSA report.

Capture a HAR from a real browser search on https://www.gozayaan.com (Network tab,
"Save all as HAR with content"), then run this importer. Fares are BDT-native.

Usage:
  python tools/import_gozayaan_har.py path\\to\\search.har [more.har ...]
"""
...
from modules.gozayaan_har import CACHE_PATH, import_hars
...
def main(argv: list[str]) -> int:
    ...
    print(f"Importing {len(paths)} GoZayaan HAR file(s)...")
